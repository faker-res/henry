...
// 状况1：有足够的积分可以兑换真钱，没有积分馀数(真钱＝整数且馀0)。
         如：300(积分)/30(兑换比例)＝10(现金) 馀 0(积分)
// 状况2：有足够的积分可以兑换真钱，且『有』积分馀数。
         如：329(积分)/30(兑换比例)＝10 (现金) 馀 29(积分)
// 状况3：有足够的积分可以兑换真钱，但部分积分超出单日可兑换限额。
         如欲兑换：300(积分)/30(兑换比例)＝10(现金) 馀 0(积分)，但今日 180(积分)
`,

    applyPointToCreditFailed: `"兑换失败，欲兑换的点数不足最低金额(1)元"
