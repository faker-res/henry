...
let dbPlayerCreditTransfer = {
     ...
     * @param forSync
     */
    playerCreditTransferFromProviderWithProviderGroup2: function (playerObjId, platform, providerId, amount, playerId, providerShortId, userName, platformId, adminName, cpName, bResolve, maxReward, forSync) {
        let pCTFP = this;
        let lockedAmount = 0;
        let rewardTaskTransferredAmount = 0;
        let validCreditToAdd = 0;
