                                ...
                                for (let j = 0; j < conditionSets.length; j++) {
                                    ...
                                    if (meetsEnoughConditions) {
                                        ...
                                        if (!levelUpEnd) {
                                            ...
                                            console.log("checkError1",errorMsg,playerObj.name? playerObj.name: "",playersTopupForPeriod, conditionSet.topupLimit, playersConsumptionForPeriod)
                                        }
                                                   ...
                                                   if (meetsEnoughConditions) {
                                                       ...
                                                       if (!checkLevelUpEnd) {
                                                           ...
                                                           if (!meetsTopupCondition && meetsConsumptionCondition) {
                                                            ...
                                                            console.log("checkError2",levelUpErrorMsg,playerObj.name? playerObj.name: "",topUpSumPeriod[topupPeriod], conditionSet.topupLimit, consumptionSumPeriod[consumptionPeriod])
                                                       }
