    ...
    calculatePartnerCommission: async (partnerObjId, startTime, endTime, commissionType) => {
        ...
        for (let i = 0; i < commConfig.length; i++) {
            ...
            if (bonusBased) {
                ...
                if (partner.partnerName == "plevel5") console.log("plevel5",'consumptionAfterFeeMulti', consumptionAfterFeeMulti, totalConsumption, platformFeeMulti, rewardFeeMulti, topUpFeeMulti, withdrawalFeeMulti)
            }
            ...
            if (partner.partnerName == "plevel5") console.log("plevel5",'rawCommission', rawCommission, 'mainParentCommissionRate', mainParentCommissionRate)
