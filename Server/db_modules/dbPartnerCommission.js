    ...
    calculatePartnerCommission: async (partnerObjId, startTime, endTime, commissionType) => {
        ...
        for (let i = 0; i < commConfig.length; i++) {
            ...
            if (bonusBased) {
                ...
                if (partner.partnerName == "plevel5") console.log('consumptionAfterFeeMulti', consumptionAfterFeeMulti, totalConsumption, platformFeeMulti, rewardFeeMulti, topUpFeeMulti, withdrawalFeeMulti)
            }
            ...
            if (partner.partnerName == "plevel5") console.log('rawCommission', rawCommission, 'mainParentCommissionRate', mainParentCommissionRate)
            ...
            for (let j = 0; j < parentChain.length; j++) {个
                ...
                if (partner.partnerName == "plevel5") console.log(parent.parentName, 'parentRatio', parentRatio, 'ratioSum', ratioSum)
                let detail = {
                    groupName: groupRate.groupName,
                    groupId: groupRate.groupId,
