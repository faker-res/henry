...
var dbPlatform = {
    ...
    resetPlatformPlayerLevelData: function (platformObjId, bWeek) {
        ...
        var queryOrArray = [{dailyTopUpSum: {$gt: 0}}, {dailyConsumptionSum: {$gt: 0}}, {dailyWithdrawSum: {$gt: 0}}, {dailyTopUpIncentiveAmount: {$gt: 0}}];
        var updateData = {dailyTopUpSum: 0, dailyConsumptionSum: 0, dailyWithdrawSum: 0, dailyTopUpIncentiveAmount: 0};
