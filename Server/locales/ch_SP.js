var simplifiedChinese = {
    ...
    "Amend Bank Info 2": "修改银行卡2",
    "Amend Bank Info 3": "修改银行卡3",
    ...
    "Voice code failed to send, please contact customer service": "语音验证发送失败，请联系客服",
    ...
    "Phone number not found, please register first!": "尚未注册，请完成注册后登录",
    ...
    "Reward": "优惠",
    "Reward Points": "积分",
    "UpdatePlayer": "编辑玩家基本资料",
    "UpdatePartner": "编辑代理基本资料",
    "Intention": "意向",
    "Others": "其他",
    ...
    "CS officer not found": "找不到对应的电销员账号",
    "Promotion method not found": "找不到对应的推广方式",
    "Credibility remark not found": "找不到对应的信用",
    ...
    "Ebet Account created Failed": "Ebet 账号建立失败！",
