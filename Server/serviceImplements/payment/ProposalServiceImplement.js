...
var ProposalServiceImplement = function () {
    ...
    this.addTestTopUp.onRequest = function (wsFunc, conn, data) {
        ...
        WebSocketUtil.performAction(conn, wsFunc, data, dbPlayerTopUpRecord.addTestTopUp, [data.platformId, data.name, data.type, data.clientType, data.onlineType, data.amount, data.createTime], isValidData);
    };
};
