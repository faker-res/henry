...
var ProposalServiceImplement = function () {
    ...
    this.setTopupProposalStatus.onRequest = function (wsFunc, conn, data) {
        ...
        WebSocketUtil.responsePromise(conn, wsFunc, data, dbProposal.updateTopupProposal, [data.proposalId, statusText, data.depositId, data.orderStatus, data.remark, data], isValidData, true, true).then(
            res => {
