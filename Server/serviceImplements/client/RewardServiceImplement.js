...
let RewardServiceImplement = function () {
    ...
    this.getPlayerRewardList.onRequest = function (wsFunc, conn, data) {
        ...
        WebSocketUtil.performAction(conn, wsFunc, data, dbPlayerInfo.getRewardsForPlayer, [conn.playerId, data.rewardType, data.startTime, data.endTime, data.startIndex, data.requestCount, data.eventCode, conn.platformId, data.status], isValidData);
    };
