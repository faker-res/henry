...
var PartnerServiceImplement = function () {
    ...
    this.getCrewActiveInfo.onRequest = function (wsFunc, conn, data) {
        ...
        WebSocketUtil.performAction(conn, wsFunc, data, dbPartner.getCrewActiveInfo, [data.platformId, conn.partnerId, data.period, data.circleTimes, data.startTime, data.endTime, data.detailCircle, data.startIndex, data.count], isValidData);
    };

    this.getCrewDepositInfo.onRequest = function (wsFunc, conn, data) {
        let isValidData = Boolean(data.platformId && conn.partnerId && data.period && (data.circleTimes || (data.startTime && data.endTime)));
        WebSocketUtil.performAction(conn, wsFunc, data, dbPartner.getCrewDepositInfo, [data.platformId, conn.partnerId, data.period, data.circleTimes, data.playerId, data.startTime, data.endTime, data.crewAccount, data.detailCircle, data.startIndex, data.count], isValidData);
    };

    this.getCrewWithdrawInfo.onRequest = function (wsFunc, conn, data) {
        let isValidData = Boolean(data.platformId && conn.partnerId && data.period && (data.circleTimes || (data.startTime && data.endTime)));
        WebSocketUtil.performAction(conn, wsFunc, data, dbPartner.getCrewWithdrawInfo, [data.platformId, conn.partnerId, data.period, data.circleTimes, data.playerId, data.startTime, data.endTime, data.crewAccount, data.detailCircle, data.startIndex, data.count], isValidData);
    };

    this.getCrewBetInfo.onRequest = function (wsFunc, conn, data) {
        let isValidData = Boolean(data.platformId && conn.partnerId && data.period && (data.circleTimes || (data.startTime && data.endTime)));
        WebSocketUtil.performAction(conn, wsFunc, data, dbPartner.getCrewBetInfo, [data.platformId, conn.partnerId, data.period, data.circleTimes, data.providerGroupId, data.playerId, data.startTime, data.endTime, data.crewAccount, data.detailCircle, data.startIndex, data.count], isValidData);
    };

    this.getNewCrewInfo.onRequest = function (wsFunc, conn, data) {
        let isValidData = Boolean(data.platformId && conn.partnerId && data.period && (data.circleTimes || (data.startTime && data.endTime)));
        WebSocketUtil.performAction(conn, wsFunc, data, dbPartner.getNewCrewInfo, [data.platformId, conn.partnerId, data.period, data.circleTimes, data.startTime, data.endTime, data.detailCircle, data.startIndex, data.count], isValidData);
    };
