...
var SettlementServiceImplement = function () {
    ...
    this.getConsumptionActivePlayerAfterTopupQueryMatch.onRequest = (wsFunc, conn, data) => {
        ...
        let args = [data.platformId, data.dayStartTime, data.dayEndTime, data.activePlayerConsumptionTimes, data.activePlayerConsumptionAmount, data.activePlayerValue, data.partnerLevelConfig,  data.consumptionCollectionName, data.isFilterValidPlayer, data.playerObjs];
