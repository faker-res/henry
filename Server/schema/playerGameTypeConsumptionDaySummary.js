...
var playerGameTypeConsumptionDaySummarySchema = new Schema({
    //player id
...
playerGameTypeConsumptionDaySummarySchema.index({ playerId: 1, platformId: 1, date: 1, gameType: 1 });

module.exports = playerGameTypeConsumptionDaySummarySchema;