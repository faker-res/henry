...
var frontEndRegistrationGuidanceSettingSchema = new Schema({
    ...
    title: {type: String},
    // categoryName
    categoryObjId: {type: Schema.Types.ObjectId, ref: 'frontEndRegistrationGuidanceCategory', required: true, index: true},
...
module.exports = frontEndRegistrationGuidanceSettingSchema;