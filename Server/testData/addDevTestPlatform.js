...
var total = platformNames.length;
...
function generatePlatform(i) {
    ...
    //todo::update game later
    //var gameCursor1 = db.game.find({"gameName": "testGame1"});
    //var game1 = gameCursor1.next();
    //
    //var gameCursor2 = db.game.find({"gameName": "testGame2"});
    //var game2 = gameCursor2.next();
    //
    //var gameCursor3 = db.game.find({"gameName": "testGame3"});
    //var game3 = gameCursor3.next();
    //
    //var gameCursor4 = db.game.find({"gameName": "testGame4"});
