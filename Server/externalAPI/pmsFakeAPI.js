...
let returnData = {
    result: {
        ...
        validTime: moment().add(30, 'm').toDate(),
        merchantNo: "test_merchant1",
        bankCardNo: "1234123412341234",
        cardOwn: "testCardOwner",
        bankTypeId: "1"
    }
};
