    ...
    this.actions = {
       ...
       getExternalUserInfo: function getExternalUserInfo(data) {
        ...
        importTSNewList: function importTSNewList(data) {
            ...
            socketUtil.emitter(self.socket, dbPlayerInfo.importTSNewList, [data.phoneNumber, data.updateData, data.isUpdateExisting, getAdminId(), getAdminName()], actionName, isValidData);
        },
