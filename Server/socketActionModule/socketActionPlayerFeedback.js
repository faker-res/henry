...
function socketActionPlayerFeedback(socketIO, socket) {
    ...
    this.actions = {
        ...
        getAllPlayerFeedbacks: function getAllPlayerFeedbacks(data) {
            ...
            socketUtil.emitter(self.socket, dbPlayerFeedback.getAllPlayerFeedbacks, [data.query, data.admin, data.cs, data.player, data.index, data.limit, data.sortCol, data.topUpTimesOperator, data.topUpTimesValue, data.topUpTimesValueTwo], actionName, isValidData);
        },
