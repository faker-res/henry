...
function socketActionPromoCode(socketIO, socket) {
    ...
    this.actions = {
        ...
        getPromoCodeTypes: function getPromoCodeTypes(data) {
            ...
            socketUtil.emitter(self.socket, dbPlayerReward.getPromoCodeTypes, [data.deleteFlag], actionName, isValidData);
        },
        ...
        updatePromoCodeSMSContent: function updatePromoCodeSMSContent(data) {
            let actionName = arguments.callee.name;
            let isValidData = Boolean(data && data.promoCodeSMSContent);
            socketUtil.emitter(self.socket, dbPlayerReward.updatePromoCodeSMSContent, [data.promoCodeSMSContent, data.isDelete], actionName, isValidData);
        },
        ...
        getPromoCodesMonitor: function getPromoCodesMonitor(data) {
            let actionName = arguments.callee.name;
            let isValidData = Boolean(data && data.platformObjId);
            socketUtil.emitter(self.socket, dbPlayerReward.getPromoCodesMonitor, [data.platformObjId, data.startAcceptedTime, data.endAcceptedTime, data.promoCodeTypeName, data.isTypeCPromo, data.index, data.limit], actionName, isValidData);
        },

        getPromoCodesAnalysisByType: function getPromoCodesAnalysisByType(data) {
            let actionName = arguments.callee.name;
            let isValidData = Boolean(data && data.platformObjId);
            socketUtil.emitter(self.socket, dbPlayerReward.getPromoCodeAnalysis, [data.platformObjId, data], actionName, isValidData);
        },

        getPromoCodesAnalysisByPlayer: function getPromoCodesAnalysisByPlayer(data) {
            let actionName = arguments.callee.name;
            let isValidData = Boolean(data && data.platformObjId);
            socketUtil.emitter(self.socket, dbPlayerReward.getPromoCodeAnalysis, [data.platformObjId, data, true], actionName, isValidData);
        },
