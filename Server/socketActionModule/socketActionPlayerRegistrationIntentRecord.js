...
function socketActionPlayerRegistrationIntentRecord(socketIO, socket) {
    ...
    this.actions = {
        ...
        createPlayerRegistrationIntentRecord: function createPlayerRegistrationIntentRecord(data) {
            ...
            socketUtil.emitter(self.socket, dbPlayerRegistrationIntentRecord.createPlayerRegistrationIntentRecord, [data, data.status, null, data.isReceiveSMS], actionName, isValidData);
        },
        /**
