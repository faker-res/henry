...
(function ($) {
    ...
    DateTimePicker.prototype = {
        ...
        place: function () {
            ...
            // editing library code is a terrible way to fix a thing, but what is done, is done.
            // I'll add an option to use back the default library code when the edited code cause problem.
            // the option will be using noInvert key - Huat
            ...
            if (this.options.noInvert) {
                ...
                var dtpHeight = this.widget.height();

                if (dtpHeight > $window.height() - offset.top){
                    offset.top = offset.top - dtpHeight - this.height;
                    this.widget.addClass('inverted');
                }else{
                    offset.top = offset.top + this.height;
                    this.widget.removeClass('inverted');
                }
            }
