...
(function () {
    ...
    d.addPrefix = function (a, b, c, e, f) {
        ...
        if (1 < a)for (k = b.length - 1; -1 < k; k--) {
            if (a >= b[k].number && (l = a / b[k].number, m = Number(e.precision), 1 > m && (m = 1), c = d.roundTo(l, m), m = d.formatNumber(c, {precision: -1, decimalSeparator: e.decimalSeparator, thousandsSeparator: e.thousandsSeparator}), !f || l == c)) {
                g = h + "" + m + "" + b[k].prefix;
                break
            }
    ...
    d.parseDefs = function (a, b) {
        for (var c in a) {
            var e = typeof a[c];
            if (0 < a[c].length && "object" == e)for (var f = 0; f < a[c].length; f++)e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][f], e); else"object" == e ? (e = document.createElementNS(d.SVG_NS, c), b.appendChild(e),
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            if (a = "object" != typeof a ? document.getElementById(a) : a) {
                ...
                var b = this.chartDiv, c = this.legendDiv, e = this.legend, f = c.style, g = b.style;
                this.measure();
            ...
            d.VML || d.SVG ? (a.handDrawn = this.handDrawn, a.handDrawScatter = this.handDrawScatter, a.handDrawThickness = this.handDrawThickness, d.remove(this.set), this.set = a.set(), d.remove(this.gridSet), this.gridSet = a.set(), d.remove(this.cursorLineSet), this.cursorLineSet = a.set(), d.remove(this.graphsBehindSet), this.graphsBehindSet = a.set(),
                ...
                a.set(), d.remove(this.balloonsSet), this.balloonsSet = a.set(), d.remove(this.plotBalloonsSet), this.plotBalloonsSet = a.set(), d.remove(this.zoomButtonSet), this.zoomButtonSet = a.set(), d.remove(this.zbSet), this.zbSet = null, d.remove(this.linkSet), this.linkSet = a.set()) : this.fire({type: "failed", chart: this})
        }, premeasure: function () {
            var a = this.div;
            if (a) {
                try {
                ...
                if (b !=
                    this.mw || c != this.mh)this.mw = b, this.mh = c, this.measure()
            }
        }, measure: function () {
            var a = this.div;
            if (a) {
                ...
                var g = d.removePx(d.getStyle(a, "padding-left")), h = d.removePx(d.getStyle(a, "padding-right")), k = d.removePx(d.getStyle(a, "padding-top")), l = d.removePx(d.getStyle(a, "padding-bottom"));
                isNaN(g) || (c -= g);
                isNaN(h) || (c -= h);
                isNaN(k) || (e -= k);
                isNaN(l) || (e -= l);
            ...
            if (this.autoTransform && window.getComputedStyle && a) {
                if (a.style) {
                    ...
                    if (b && (b = b.getPropertyValue("-webkit-transform") || b.getPropertyValue("-moz-transform") ||
                            b.getPropertyValue("-ms-transform") || b.getPropertyValue("-o-transform") || b.getPropertyValue("transform")) && "none" !== b) {
        ...
        clear: function (a) {
            ...
            if (b.container && !1 !== a.enabled) {
                ...
                var c = a.y, e = a.text, f = a.align, g = a.size, h = a.color, k = a.rotation,
            ...
            if (c) {
                ...
                c.ieW && (d = c.ieW);
                var g = e.offsetHeight, e = e.style, h = this.chartDiv.style, c = c.position;
                if ("right" == c || "left" == c) {
                    a -= d;
                    if (0 > a || isNaN(a))a = 0;
                    h.width = a + "px";
            ...
            this.skipEvents || (this.dispatchDataUpdated && (this.dispatchDataUpdated = !1, this.fire({type: "dataUpdated", chart: this})), this.chartCreated || (this.chartCreated = !0, this.fire({type: "init", chart: this})),
            this.chartRendered || (this.fire({type: "rendered", chart: this}), this.chartRendered = !0), this.fire({type: "drawn", chart: this}));
            this.skipEvents = !1
        ...
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var p = this.horizontalPadding, y = this.verticalPadding, x = this.pointerWidth, u = this.pointerOrientation, A = this.cornerRadius,
                    ...
                    w < h && (w = h);
                    w + z > l && (w = l - z);
                    var k = B + y, m = w + p, G = this.shadowAlpha, D = this.shadowColor, p = this.borderThickness, K = this.bulletSize, J, y = this.fillAlpha, L = this.borderAlpha;
                    this.showBullet && (J = d.circle(f, K, r, y), g.push(J));
                    this.drop ? (h = z / 1.6, l = 0, "V" == u && (u = "down"), "H" == u && (u = "left"), "down" == u && (w = a + 1, B = b - h - h / 3), "up" == u && (l = 180, w = a + 1, B = b + h + h / 3), "left" == u && (l = 270, w = a + h + h / 3 + 2, B = b), "right" == u && (l = 90, w = a - h - h / 3 + 2, B = b), k = B - E / 2 + 1, m = w - F / 2 - 1, q = d.drop(f, h, l, q, y, p, t, L)) : 0 < A || 0 === x ? (0 < G && (a = d.rect(f, z, v, q, 0, p + 1, D,
                        G, A), d.isModern ? a.translate(1, 1) : a.translate(4, 4), g.push(a)), q = d.rect(f, z, v, q, y, p, t, L, A)) : (r = [], A = [], "H" != u ? (h = a - w, h > z - x && (h = z - x), h < x && (h = x), r = [0, h - x, a - w, h + x, z, z, 0, 0], A = H ? [0, 0, b - B, 0, 0, v, v, 0] : [v, v, b - B, v, v, 0, 0, v]) : (u = b - B, u > v - x && (u = v - x), u < x && (u = x), A = [0, u - x, b - B, u + x, v, v, 0, 0], r = a < h + (l - h) / 2 ? [0, 0, w < a ? 0 : a - w, 0, 0, z, z, 0] : [z, z, w + z > a ? z : a - w, z, z, 0, 0, z]), 0 < G && (a = d.polygon(f, r, A, q, 0, p, D, G), a.translate(1, 1), g.push(a)), q = d.polygon(f, r, A, q, y, p, t, L));
                    this.bg = q;
                    g.push(q);
                    q.toFront();
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (g.translate(this.prevX, this.prevY, NaN, !0), g.animate({translate: w - f + "," + B}, b, "easeOutSine"), n && (C.left = this.prevTX + "px", C.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine",
...
(function () {
    ...
    d.polygon = function (a, b, c, e, f, g, h, k, l, m, n) {
        ...
        void 0 === h && (h = q);
        f = {fill: q, stroke: h, "fill-opacity": f, "stroke-width": g, "stroke-opacity": k};
    ...
    d.rect = function (a, b, c, e, f, g, h, k, l, m, n) {
        ...
        r += d.dx;
        p += d.dy;
        f = {fill: q, stroke: h, "fill-opacity": f, "stroke-opacity": k};
        void 0 !== n && 0 < n && (f["stroke-dasharray"] = n);
    ...
    d.bullet = function (a, b, c, e, f, g, h, k, l, m, n, q, t) {
        ...
        switch (b) {
            ...
            case "square":
                r = d.polygon(a, [-c /
                2, c / 2, c / 2, -c / 2], [c / 2, c / 2, -c / 2, -c / 2], e, f, g, h, k, m - 180, void 0, t);
                break;
            case "rectangle":
    ...
    d.makeHD = function (a, b, c) {
        for (var e = [], d = [], g = 1; g < a.length; g++)for (var h = Number(a[g - 1]), k = Number(b[g - 1]), l = Number(a[g]), m = Number(b[g]),
    ...
    d.handDrawnLine = function (a, b, c, e, f, g, h, k, l, m) {
        var n, q = a.set();
        for (n = 1; n < b.length; n++)for (var t = [b[n - 1], b[n]], r = [c[n - 1], c[n]], r = d.makeHD(t, r, a.handDrawScatter), t = r[0], r = r[1], p = 1; p < t.length; p++)q.push(d.line(a, [t[p - 1], t[p]], [r[p - 1], r[p]], e, f, g + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, !0));
        return q
    };
    d.doNothing =
        function (a) {
    ...
    d.drop = function (a, b, c, e, d, g, h, k) {
        var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, q = Math.cos(m * l) * b, t = Math.sin((m + 40) * l) * b, r = Math.cos((m + 40) * l) * b, p = .8 * b, y = -b / 3, x = b / 3;
        0 === c && (y = -y, x = 0);
        180 == c && (x = 0);
        90 == c && (y = 0);
        270 == c && (y = 0, x = -x);
    ...
    d.wedge = function (a, b, c, e, f, g, h, k, l, m, n, q, t, r) {
        ...
        h = p(h);
        k = p(k);
        var y = p(h / g * k), x = d.VML, u = 359.5 + g / 100;
        359.94 < u && (u = 359.94);
        f >= u && (f = u);
        var A = 1 / 180 * Math.PI, u = b + Math.sin(e * A) * k, v = c - Math.cos(e * A) * y, B = b + Math.sin(e * A) * g, C = c - Math.cos(e * A) * h, w = b + Math.sin((e + f) * A) * g, z = c - Math.cos((e + f) * A) * h, F = b + Math.sin((e + f) * A) * k, A = c - Math.cos((e + f) * A) * y, E = {fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"]}, H = 0;
        180 < Math.abs(f) && (H = 1);
        e = a.set();
        var G;
        ...
        if (0 < l) {
            ...
            l = a.path(" M" + w + "," + z + " L" + w + "," + (z + l) + " L" + F + "," + (A + l) + " L" + F + "," + A + " L" + w + "," + z + " Z", void 0, void 0,
                "1000,1000").attr(E);
            e.push(D);
            e.push(l)
        }
        ...
        a.handDrawn && (k = d.line(a, [u, B], [v, C], m.stroke, m.thickness * Math.random() * a.handDrawThickness, m["stroke-opacity"]),
            e.push(k));
...
(function () {
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.chart, b = this.position, c = this.width, e = a.divRealWidth, f = a.divRealHeight, g = this.div, h = this.legendData;
            this.data && (h =
                this.data);
            ...
            var a = this.position, b = this.marginLeft +
                this.titleWidth, c = this.marginRight, e = this.marginTop, f = this.marginBottom, g = this.horizontalGap, h = this.div, k = this.divWidth, l = this.maxColumnsReal, m = this.verticalGap, n = this.spacing, q = k - c - b, t = 0, r = 0, p = this.container;
            this.set && this.set.remove();
            var y = p.set();
            this.set = y;
            var x = p.set();
            y.push(x);
            var u = this.entries, A, v;
            ...
            var B = r = 0, C = g, w = 0, z = 0;
            for (v = 0; v < u.length; v++) {
                var F = u[v];
                this.reversedOrder && (F = u[u.length - v - 1]);
                A = F.getBBox();
                var E;
                this.equalWidths ? E = B * (t + n + this.markerLabelGap) : (E = C, C = C + A.width + g + n);
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                var b = this, c = b.chart, e = a.markerType;
                a.legendEntryWidth =
                    b.markerSize;
                e || (e = b.markerType);
                ...
                var k = a.pattern, l = a.customMarker;
                l || (l = b.customMarker);
                var m = b.container, n = b.markerSize, q = 0, t = 0, r = n / 2;
                if (b.useGraphSettings) {
                    ...
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e)k = m.set(), a.hidden || (f = a.lineColorR, h = a.bulletBorderColorR), q = d.line(m, [0, 2 * n], [n / 2, n / 2], f, a.lineAlpha, a.lineThickness,
                        a.dashLength), d.setCN(c, q, "graph-stroke"), k.push(q), a.bullet && (a.hidden || (f = a.bulletColorR), q = d.bullet(m, a.bullet, a.bulletSize, f, a.bulletAlpha, a.bulletBorderThickness, h, a.bulletBorderAlpha)) && (d.setCN(c, q, "graph-bullet"), q.translate(n + 1, n / 2), k.push(q)), r = 0, q = n, t = n / 3; else {
                        var p;
                ...
                } else if (l)k = m.image(l, 0, 0, n, n); else {
                    var y;
                ...
                h = b.switchType;
                var x;
                h && "none" != h && 0 < n && ("x" == h ? (x = b.createX(), x.translate(n / 2, n / 2)) : x = b.createV(),
                    x.dItem = a, !0 !== a.hidden ? "x" == h ? x.hide() : x.show() : "x" != h && x.hide(), b.switchable || x.hide(), b.addListeners(x, a), a.legendSwitch = x, m.push(x), d.setCN(c, x, "legend-switch"));
                h = b.color;
                ...
                c.accessible && b.accessibleLabel && (p = d.massReplace(b.accessibleLabel, {"[[title]]": a.title}), c.makeAccessible(m, p));
                p = b.fontSize;
                k && (n <= p && (n = n / 2 + b.ly - p / 2 + (p + 2 - n) / 2 - t, k.translate(r, n), x && x.translate(x.x, n)), a.legendEntryWidth = k.getBBox().width);
                var u;
                f && (f = d.fixBrakes(f), a.legendTextReal = f, u = b.labelWidth, u = isNaN(u) ? d.text(b.container, f, h, c.fontFamily, p, "start") : d.wrappedText(b.container, f, h, c.fontFamily, p, "start", !1, u, 0), d.setCN(c, u, "legend-label"), u.translate(b.lx + q, b.ly), m.push(u),
                    b.labelDx = q, c = u.getBBox().width, b.maxLabelWidth < c && (b.maxLabelWidth = c));
                b.entries[b.index] = m;
            ...
            this.switchable &&
            this.dispatch("rollOutMarker", a, b);
            ...
            if (!a.hidden) {
                if (this.textClickEnabled && a.legendLabel) {
                    ...
                    a.showBalloon && (c = this.selectedColor);
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (b.valueText && 0 < b.valueWidth) {
                    ...
                    !0 === a.hidden && (h = b.markerDisabledColor);
                    var k = b.valueText, f = f + b.lx + b.labelDx + b.markerLabelGap + b.valueWidth, l = "end";
                    "left" == b.valueAlign &&
                ...
                c = b.container.rect(a.legendEntryWidth, 0, g, e, 0, 0).attr({stroke: "none", fill: "#fff", "fill-opacity": .005});
                c.dItem = a;
            ...
            if (a)for (c = 0; c < a.length; c++) {
                ...
                if (e)g.value ? f.text(g.value) : f.text(""); else {
                    ...
                    if (void 0 !== g.type) {
                        ...
                        k ? (h = this.valueText, g.legendValueText && (h = g.legendValueText),
                            h = b.formatString(h, k)) : l && b.formatPeriodString && (l = d.massReplace(l, {"[[title]]": g.title}), h = b.formatPeriodString(l, g))
                    ...
                    if (this.useMarkerColorForLabels) {
                        if (f = g.legendMarker)f.setAttr("fill", n), f.setAttr("stroke",
                            n);
    ...
    d.AmMap = d.Class({
        inherits: d.AmChart, construct: function (a) {
            ...
            if (this.sizeChanged && d.hasSVG && this.chartCreated) {
                ...
                "", this.chartDiv.setAttribute("class", "ammapAlert"), this.chartDiv.innerHTML = this.svgNotSupported, this.fire({type: "failed", chart: this}))
        }, storeTemp: function () {
        ...
        drawBg: function () {
            ...
            b = b.objectsToResize;
            for (c =
                     0; c < b.length; c++)e = b[c], e.translate(e.x, e.y, 1 / a, !0)
        }, handleTouchEnd: function (a) {
            ...
            if (this.chartCreated && !this.preventHover && (this.initialTouchZoom = this.zoomLevel(), this.dragMap && (this.stopAnimation(), this.mapContainerClickX =
                    this.mapContainer.x, this.mapContainerClickY = this.mapContainer.y), a || (a = window.event), a.shiftKey && !0 === this.developerMode && this.getDevInfo(), a && a.touches)) {
            ...
            if (d.isModern) {
                ...
                if (!a.preventHover) {
                    ...
                    isNaN(c) || isNaN(e) || !(3 < Math.abs(b.x - c) || 3 < Math.abs(b.y - e)) || (a.mapWasDragged = !0, b = {type: "dragCompleted", zoomX: a.zoomX(), zoomY: a.zoomY(), zoomLevel: a.zoomLevel(), chart: a},
                        a.fire(b));
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a = b.mapContainer) {
                    ...
                    if (!isNaN(k)) {
                        b.stopDrag();
                        var r = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - g, 2)), p = b.initialDistance;
                        isNaN(p) && (p = Math.sqrt(Math.pow(k - f, 2) + Math.pow(l - g, 2)));
                        if (!isNaN(p)) {
                            var k = b.initialTouchZoom * r / p, k = d.fitToBounds(k, h.minZoomLevel,
                                h.maxZoomLevel), h = b.zoomLevel(), p = b.middleXP, l = b.middleYP, r = m / t, y = n / q, p = (b.zoomX() - p * y) * (k / h) + p * y, l = (b.zoomY() - l * r) * (k / h) + l * r;
            ...
            }, 1E3 * e + 200), c.showObjectsAfterZoom) ? b || (c.processObjectsTimeOut =
                setTimeout(function () {
            ...
            var f = this.realWidth, g = this.realHeight, h = this.mapSet.scale, k = this.zoomControl, f = d.fitToBounds(c / f > e / g ? .8 * f / (c * h) : .8 * g / (e * h), k.minZoomLevel, k.maxZoomLevel);
            this.zoomToMapXY(f, (a + c / 2) * h, (b + e / 2) * h)
        }, zoomToLatLongRectangle: function (a, b, c, e) {
            var f = this.dataProvider,
                g = this.zoomControl, h = Math.abs(c - a), k = Math.abs(b - e), l = Math.abs(f.rightLongitude - f.leftLongitude), f = Math.abs(f.topLatitude - f.bottomLatitude), g = d.fitToBounds(h / l > k / f ? .8 * l / h : .8 * f / k, g.minZoomLevel, g.maxZoomLevel);
            ...
            if (a) {
                ...
                var e = a.zoomLevel, f = this.zoomInstantly, g = a.zoomX, h = a.zoomY, k = this.realWidth, l = this.realHeight;
                isNaN(e) || (isNaN(b) || isNaN(c) ? this.zoomTo(e, g, h, f) : this.zoomToLongLat(e, c, b, f));
                this.zoomInstantly = !1;
                "MapImage" == a.objectType && isNaN(a.zoomX) && isNaN(a.zoomY) && isNaN(a.zoomLatitude) && isNaN(a.zoomLongitude) && !isNaN(a.latitude) && !isNaN(a.longitude) && this.zoomToLongLat(a.zoomLevel, a.longitude,
                    a.latitude);
            ...
            this.stopAnimation();
            isNaN(a) || (f = this.mapContainer, this.initialX = f.x, this.initialY = f.y, this.initialScale = f.scale, this.finalX = this.mapWidth * b, this.finalY = this.mapHeight * c, this.finalScale = a, this.finalX != this.initialX || this.finalY != this.initialY || this.finalScale !=
            this.initialScale ? e ? (this.tweenPercent = 1, this.rescaleMapAndObjects(), this.wheelBusy = !1) : this.animateMap() : this.wheelBusy = !1)
        }, loadXml: function (a) {
            var b;
            ...
            if (0 < a.images.length || 0 < a.areas.length || 0 < a.lines.length ||
                a == this.dataProvider) {
                ...
                this.linesAboveImages ? (f.toFront(), c.toFront(),
                    g.toFront(), d.toFront()) : (g.toFront(), d.toFront(), f.toFront(), c.toFront());
            ...
            a.mousedown(function (a) {
                ...
                c.tapToActivate && !c.tapped || c.mapWasDragged || c.mapWasPinched || (c.balloonX = NaN, c.rollOverMapObject(b,
                    !0, a), c.clickMapObject(b, a))
            }).touchstart(function (a) {
                c.tmx = c.mouseX;
                c.tmy = c.mouseY;
                c.mouseDownMapObject(b, a)
            ...
            if (!a.showAsSelected && b && !a.isOver) {
                ...
                if (void 0 != c)if ("MapImage" ==
                    a.objectType)(e = a.image) && e.setAttr("fill", c); else if ("MapLine" == a.objectType) {
                ...
                "MapImage" == a.objectType ? (c = this.imagesSettings.rollOverOutlineThickness, (e = a.image) &&
                (isNaN(c) || e.setAttr("stroke-width", c))) : (c = this.areasSettings.rollOverOutlineThickness, isNaN(c) || b.setAttr("stroke-width", c));
            ...
            if (this.chartCreated) {
                ...
                d && d != a ? (!1 === this.checkIfSelected(d) && (this.returnInitialColor(d, !0), this.previouslyHovered =
                    null), this.balloon.hide(0)) : clearTimeout(this.hoverInt);
            ...
            void 0 ==
            h && (h = "");
            return a = d.massReplace(a, {"[[title]]": f, "[[value]]": g, "[[percent]]": c, "[[description]]": e, "[[customData]]": h})
            ...
            if (c.chartCreated && !c.preventHover && c.checkTouchDuration(b) && !c.mapWasDragged && c.checkIfClickable(a) && !c.mapWasPinched) {
                c.selectObject(a);
                var d = c.zoomLevel(),
                    f = c.mapSet.getBBox(), d = c.xyToCoordinates((c.mouseX - c.mapContainer.x) / d - f.x * c.mapScale, (c.mouseY - c.mapContainer.y) / d - f.y * c.mapScale);
        ...
        moveRight: function () {
            ...
            if (a.description) {
                ...
                var c = a.descriptionWindowWidth, e = a.descriptionWindowHeight, f = a.descriptionWindowLeft, g = a.descriptionWindowTop, h = a.descriptionWindowRight, k = a.descriptionWindowBottom;
            ...
            if (this.mapContainer) {
                var a = this.mapSet.getBBox(), b = (-this.mapContainer.x + this.previousWidth /
                    2) / this.zoomLevel() - a.x * this.mapScale, a = (-this.mapContainer.y + this.previousHeight / 2) / this.zoomLevel() - a.y * this.mapScale;
            ...
            if (c) {
                ...
                for (f = 0; f < k; f++) {
                    ...
                    if (0 !== g.childNodes.length || "" !== m || !1 !== n)if (3 == g.nodeType || 4 == g.nodeType) {
                        ...
                        1]) : (a[b][l] = {}, q = a[b][l]);
                        if (g.attributes && g.attributes.length)for (m = 0; m < g.attributes.length; m++)q[g.attributes[m].name] = g.attributes[m].value;
            ...
            var a =
                this.zoomLevel(), b = this.mapSet.getBBox(), b = this.xyToCoordinates((this.mouseX - this.mapContainer.x) / a - b.x * this.mapScale, (this.mouseY - this.mapContainer.y) / a - b.y * this.mapScale), a = {
                chart: this, type: "writeDevInfo", zoomLevel: a, zoomX: this.zoomX(), zoomY: this.zoomY(), zoomLatitude: this.zoomLatitude(), zoomLongitude: this.zoomLongitude(), latitude: b.latitude, longitude: b.longitude, left: this.mouseX, top: this.mouseY, right: this.realWidth - this.mouseX, bottom: this.realHeight - this.mouseY, percentLeft: Math.round(this.mouseX /
                    this.realWidth * 100) + "%", percentTop: Math.round(this.mouseY / this.realHeight * 100) + "%", percentRight: Math.round((this.realWidth - this.mouseX) / this.realWidth * 100) + "%", percentBottom: Math.round((this.realHeight - this.mouseY) / this.realHeight * 100) + "%"
            ...
            for (var c = 0; c < b.length; c++) {
                ...
                if (d) {
                    for (var d = d.split("L"), f = [], g = 0; g < d.length; g++)if (d[g]) {
                        var h =
                            d[g].split(" "), h = this.xyToCoordinates(Number(h[1]), Number(h[2]), this.dpProjectionFunction, this.sourceMapWidth, this.sourceMapHeight);
            ...
            for (var b = !1, c = "", e = 0; e < a.length; e++) {
                var f = a[e][0], g = a[e][1], h = d.degreesToRadians(a[e][0]), k = d.degreesToRadians(a[e][1]), k = this.projectionFunction(h, k), h = d.roundTo(this.x2c(d.radiansToDegrees(k[0])),
                    3), k = d.roundTo(this.y2c(d.radiansToDegrees(k[1])), 3);
            ...
            var a = d.degreesToRadians(this.dataProvider.leftLongitude), b = d.degreesToRadians(this.dataProvider.rightLongitude), c = d.degreesToRadians(this.dataProvider.topLatitude),
                e = d.degreesToRadians(this.dataProvider.bottomLatitude), f = a + (b - a) / 2, g = c + (e - c) / 2, h = this.dpProjectionFunction(f, c)[1], k = this.dpProjectionFunction(f, e)[1], l = this.dpProjectionFunction(a, g)[0], m = this.dpProjectionFunction(b, g)[0];
            ...
            var c = this.coordinatesToXY(a,
                b), d = c.x * this.zoomLevel() + this.mapContainer.x, c = c.y * this.zoomLevel() + this.mapContainer.y;
            return {x: d, y: c}
...
(function () {
    ...
    d.ZoomControl = d.Class({
        construct: function (a) {
            ...
            var f = c.buttonSize, g = c.zoomControlEnabled, h = c.panControlEnabled, k = c.buttonFillColor, l = c.buttonFillAlpha, m = c.buttonBorderThickness,
                n = c.buttonBorderColor, q = c.buttonBorderAlpha, t = c.buttonCornerRadius, r = c.buttonRollOverColor, p = c.gridHeight, y = c.zoomFactor, x = c.minZoomLevel, u = c.maxZoomLevel, A = c.buttonIconAlpha, v = c.buttonIconColor, B = c.roundButtons, C = a.svgIcons, w = a.getX(c.left), z = a.getY(c.top);
    ...
    d.SmallMap = d.Class({
        construct: function (a) {
            ...
            if (c.enabled) {
                ...
                e.push(f);
                c.buildSVGMap();
                var g = c.borderThickness, h = c.borderColor, k = d.rect(b, c.width + g, c.height + g, c.backgroundColor, c.backgroundAlpha, g, h, c.borderAlpha);
            ...
            var a = this.chart, b = {fill: this.mapColor, stroke: this.mapColor, "stroke-opacity": 1}, c = this.container, e = c.set();
            ...
            var a = this.chart;
            if (a) {
                var b = a.zoomLevel(), c = this.width, d = this.height, f = c / (a.realWidth * b), g = a.mapContainer.getBBox(), c = c / b, d = d / b, h = this.rectangle;
...
(function () {
    ...
    d.AreasProcessor = d.Class({
        construct: function (a) {
            ...
            this.allObjects = [];
            a = a.areas;
            var b = this.chart, c = a.length, d, f, g = 0, h = !1, k = !1, l = 0;
            for (d = 0; d < c; d++)if (f = a[d], f = f.value, !isNaN(f)) {
                if (!1 === h || h < f)h = f;
                if (!1 === k || k > f)k = f;
                g += Math.abs(f);
                l++
            ...
            var g = e.color, h = e.alpha, k = e.outlineThickness, l = e.rollOverColor, m = e.selectedColor, n = e.rollOverAlpha, q = e.rollOverBrightness, t = e.outlineColor, r = e.outlineAlpha, p = e.balloonText, y = e.selectable, x = e.pattern, u = e.rollOverOutlineColor, A = e.bringForwardOnHover, v = e.preserveOriginalAttributes;
...
(function () {
    ...
    d.ImagesProcessor = d.Class({
        construct: function (a) {
            ...
            var c = this.chart, e = c.container, f = c.mapImagesContainer, g = c.stageImagesContainer, h = c.imagesSettings;
            a.remove &&
            a.remove();
            var k = h.color, l = h.alpha, m = h.rollOverColor, n = h.rollOverOutlineColor, q = h.selectedColor, t = h.balloonText, r = h.outlineColor, p = h.outlineAlpha, y = h.outlineThickness, x = h.selectedScale, u = h.rollOverScale, A = h.selectable, v = h.labelPosition, B = h.labelColor, C = h.labelFontSize, w = h.bringForwardOnHover, z = h.labelRollOverColor, F = h.rollOverBrightness, E = h.selectedLabelColor;
            a.index = b;
            a.chart = c;
            ...
            if (F) {
                ...
                D.translate(A, p, n, !0)
            } else u ? (isNaN(C) && (C = 10), isNaN(E) && (E = 10), D = e.image(u, 0, 0, C, E), D.node.setAttribute("preserveAspectRatio", "none"), D.setAttr("opacity", k), a.centeredReal && (A = isNaN(a.right) ? -C / 2 : C / 2, p = isNaN(a.bottom) ? -E / 2 : E / 2, D.translate(A, p, NaN,
                !0))) : x && (D = e.path(x), F = D.getBBox(), a.centeredReal ? (A = -F.x * n - F.width * n / 2, isNaN(a.right) || (A = -A), p = -F.y * n - F.height * n / 2, isNaN(a.bottom) || (p = -p)) : A = p = 0, D.translate(A, p, n, !0), D.x = A, D.y = p);
            ...
            var b = this.chart, c = a.displayObject, e = b.getX(a.left),
                f = b.getY(a.top), g, h = a.image.getBBox();
            ...
            if (!isNaN(e) && !isNaN(f))c.translate(e, f, NaN, !0); else if (!isNaN(l) && !isNaN(k))if (f = b.coordinatesToXY(k, l), e = f.x, f = f.y, isNaN(t) || (e = t), isNaN(r) || (f = r), a.fixedSize) {
                t = 1;
                if (a.showAsSelected ||
                    b.selectedObject == a)t = a.selectedScaleReal;
                b = a.positionScale;
            ...
            } else c.translate(e, f, NaN, !0), n && (this.labelsToReposition.push(a), a.arrays.push({arr: this.labelsToReposition, el: a}));
            ...
            switch (e) {
                ...
                case "rectangle":
                    k = d.polygon(h,
                        [-f / 2, f / 2, f / 2, -f / 2], [g / 2, g / 2, -g / 2, -g / 2], a, 1, c, b, 1, 0, !0);
                    break;
                case "bubble":
    ...
    d.LinesProcessor = d.Class({
        construct: function (a) {
            ...
            var c = this.chart, e = c.linesSettings, f = this.objectsToResize, g = c.mapLinesContainer,
                h = c.stageLinesContainer, k = e.thickness, l = e.dashLength, m = e.arrow, n = e.arrowSize, q = e.arrowColor, t = e.arrowAlpha, r = e.color, p = e.alpha, y = e.rollOverColor, x = e.selectedColor, u = e.rollOverAlpha, A = e.balloonText, v = e.bringForwardOnHover, B = e.arc, C = e.rollOverBrightness, w = c.container;
            a.chart = c;
            a.baseSettings = e;
            var z = w.set();
            a.displayObject = z;
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                e = a.latitudes;
                p = n.length;
                if (0 < p)for (v = [], C = [], u = 0; u < p; u++)x = c.coordinatesToXY(n[u], e[u]), v.push(x.x), C.push(x.y);
                if (0 < v.length) {
                    a.segments = v.length;
                    d.dx = 0;
                    d.dy = 0;
                    ...
                    if (isNaN(p)) {
                        for (p = 0; p < v.length - 1; p++)H =
                            Math.sqrt(Math.pow(v[p + 1] - v[p], 2) + Math.pow(C[p + 1] - C[p], 2)), a.distances[p] = H;
                        ...
                        u = 1;
                        0 > A && (u = 0);
                        x = {fill: "none", stroke: l, "stroke-opacity": 1, "stroke-width": F / n, "fill-opacity": 0, "stroke-linecap": "round"};
                    ...
                    a.fixedSize && p && (f = {line: p, thickness: F}, this.linesToResize.push(f), a.arrays.push({arr: this.linesToResize, el: f}), f = {line: l, thickness: 5}, this.linesToResize.push(f), a.arrays.push({arr: this.linesToResize, el: f}));
                    a.lineSvg = p;
...
(function () {
    ...
    d.MapImage = d.Class({
        ...
        remove: function () {
            ...
            a.fire({type: "animationStart", chart: a.chart, image: this, lineSegment: a.lineSegment, direction: a.direction})
        }, clearTO: function () {
...
(function () {
    ...
    d.winkel3.invert = function (a, b) {
        ...
        do var h = Math.cos(e), k = Math.sin(e),
            l = Math.sin(2 * e), m = k * k, n = h * h, q = Math.sin(c), t = Math.cos(c / 2), r = Math.sin(c / 2), p = r * r, y = 1 - n * t * t, x = y ? d.acos(h * t) * Math.sqrt(u = 1 / y) : u = 0, u, y = .5 * (2 * x * h * r + c / g) - a, A = .5 * (x * k + e) - b, v = .5 * u * (n * p + x * h * t * m) + .5 / g, B = u * (q * l / 4 - x * k * r), k = .125 * u * (l * r - x * k * n * q), m = .5 * u * (m * t + x * p * h) + .5, h = B * k - m * v, B = (A * B - y * m) / h, y = (y * k - A * v) / h, c = c - B, e = e - y; while ((1E-6 < Math.abs(B) || 1E-6 < Math.abs(y)) && 0 < --f);
        return [c, e]
    };
