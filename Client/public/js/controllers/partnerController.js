        ...
        function initPageParam() {
            ...
            vm.checkChildPartnerNameValidity = function (name, idx) {
                ...
                socketService.$socket($scope.AppSocket, 'checkChildPartnerNameValidity', {
                    ...
                    $scope.$evalAsync(() => {
                        if (data && data.data && data.data.hasOwnProperty('isExist') && data.data.isExist.toString() == 'false') {
                            vm.disableEditChildPartner = true;
                            vm.childPartnerList[idx].errorMessage = $translate('PARTNER_NAME_DOES_NOT_EXISTS');
                        } else if (data && data.data && data.data.hasOwnProperty('isExist') && data.data.isExist.toString() == 'true') {
                            vm.disableEditChildPartner = true;
                        ...
                        } else if (data && data.data && data.data.hasOwnProperty('isOwnParent') && data.data.isOwnParent.toString() == 'true') {
                            vm.disableEditChildPartner = true;
