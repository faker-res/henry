            ...
            socketService.$socket($scope.AppSocket, 'getQueryProposalsForAdminId', queryData, function (data) {
                ...
                var option = $.extend({}, vm.generalDataTableOptions, {
                    ...
                    aoColumnDefs: [
                        ...
                        {'sortCol': 'platformId', bSortable: true, 'aTargets': [1]},
                        {'sortCol': 'status', bSortable: true, 'aTargets': [2]},
                        {'sortCol': 'actionName', bSortable: true, 'aTargets': [3]},
                        {'sortCol': 'playerId', bSortable: true, 'aTargets': [4]},
                        {'sortCol': 'playerName', bSortable: true, 'aTargets': [5]},
                        {'sortCol': 'partner', bSortable: true, 'aTargets': [6]},
                        {'sortCol': 'referral', bSortable: true, 'aTargets': [7]},
                        {'sortCol': 'amount', bSortable: true, 'aTargets': [8]},
                        {'sortCol': 'ip', bSortable: true, 'aTargets': [9]},
                        {'sortCol': 'createTime', bSortable: true, 'aTargets': [10]},
                        {'sortCol': 'processTime', bSortable: true, 'aTargets': [11]},
                        {'sortCol': 'phoneNumber', bSortable: true, 'aTargets': [11]},
                    ...
                    columns: [
                        ...
                        {title: $translate('PROVIDER'), data: "data.platformId"},
                        {title: $translate('PROVIDER'), data: "status"},
                        {title: $translate('PROVIDER'), data: "status"},
                        {title: $translate('PLAYERID'), data: "data.playerId"},
                        {title: $translate('PLAYERNAME'), data: "data.playerName"},
                        {title: 'partner', data: ""},
                        {title: 'referral', data: ""},
                        {title: 'amount', data: ""},
                        {title: $translate('IP_ADDRESS'), data: ""},
                        {title: $translate('CREATETIME'), data: "createTime"},
                        {title: 'ProcessTime', data: ""},
